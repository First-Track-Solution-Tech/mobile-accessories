...
const ReturnPolicy = () => {
  return (
    <>
      <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 py-16 px-6 md:px-12 min-h-screen">
        <div className="max-w-6xl mx-auto bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl p-10 border border-gray-200">
          ...
          <div className="flex flex-wrap justify-between items-center mb-12 text-sm text-gray-600">
            {["Request", "Approval", "Pickup", "Refund"].map(
              (step, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center flex-1 mb-4"
                >
